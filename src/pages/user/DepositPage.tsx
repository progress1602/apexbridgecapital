...
const paymentMethods = [
  { id: 'btc', name: 'Bitcoin (BTC)', icon: Bitcoin, color: 'text-brand-purple', address: 'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh' },
              ...
              >
                    ...
                    {paymentMethods.map((m) => (
                      <button
                        ...
                        className={cn(
                          ...
                          method.id === m.id ? "bg-brand-black-light border-brand-purple/40 shadow-inner" : "bg-transparent border-zinc-800/50 hover:bg-zinc-900/50 hover:border-zinc-700"
                        )}
                      >
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-end text-[10px] font-black text-zinc-600 uppercase tracking-[0.3em] italic font-mono">
                    ...
                    <span className="text-brand-purple/60 flex items-center gap-2"><AlertCircle size={12} /> Min: $100</span>
                  </div>
                ...
                <button 
                  ...
                  onClick={() => setStep(2)}
                  className="w-full py-7 bg-brand-purple text-black rounded-[32px] font-black uppercase tracking-[0.3em] text-xs hover:bg-brand-purple-hover transition-all disabled:opacity-30 shadow-[0_20px_50px_rgba(75,47,168,0.2)] active:scale-[0.98]"
                >
                  Confirm Strategy
                </button>
              </motion.div>
              ...
              >
                <div className="p-12 rounded-[40px] bg-brand-purple/5 border border-brand-purple/10 text-center relative overflow-hidden group">
                   ...
                   <div className="inline-flex items-center gap-3 px-4 py-2 bg-black/40 backdrop-blur-md rounded-full border border-white/5">
                      <method.icon size={12} className="text-brand-purple" />
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                   ...
                   <button onClick={() => setStep(3)} className="flex-[2] py-6 bg-brand-purple text-black rounded-[24px] font-black uppercase tracking-[0.2em] text-[10px] hover:bg-brand-purple-hover shadow-xl shadow-brand-purple/20 active:scale-[0.98] transition-all">Protocol Transmitted</button>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                   ...
                   <button 
                     ...
                     className="flex-[2] py-6 bg-brand-purple text-black rounded-[24px] font-black uppercase tracking-[0.2em] text-[10px] hover:bg-brand-purple-hover shadow-xl shadow-brand-purple/20 transition-all flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-30"
                   >
