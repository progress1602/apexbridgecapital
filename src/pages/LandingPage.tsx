      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800/50 bg-[#070708]/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-24 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 md:gap-3 group relative z-50">
            <div className="w-8 h-8 md:w-12 md:h-12 bg-emerald-500 rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.3)] group-hover:scale-110 transition-transform duration-500 shrink-0">
               <TrendingUp size={20} className="text-black md:size-6" />
            </div>
            <span className="text-sm md:text-2xl font-bold tracking-tight text-white font-serif italic uppercase truncate">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <div className="relative z-10 flex bg-black flex-col pt-32 px-10 gap-10">
                {[
              ...
              <div className="mt-auto p-10 space-y-4 border-t border-zinc-900 bg-black relative z-10">
                <Link 
                  to="/login" 
                  onClick={() => setIsMenuOpen(false)}
      ...
      <main className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="xl:col-span-7 space-y-8 md:space-y-12">
              ...
              >
                ...
                <h1 className="text-3xl sm:text-6xl md:text-8xl font-black text-white leading-[0.9] md:leading-[0.85] tracking-tighter italic font-serif text-balance">
                  PRECISION <br className="hidden sm:block" />
                  <span className="text-zinc-600 block mt-2 animate-pulse">CAPITAL.</span>
                </h1>
                
                <p className="text-zinc-500 text-base md:text-xl max-w-xl mt-6 md:mt-10 leading-relaxed font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-4 md:gap-5 mt-8 md:mt-12">
                  <Link to="/signup" className="flex items-center justify-center gap-3 px-6 md:px-10 py-4 md:py-5 bg-emerald-500 text-black rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-[10px] md:text-[11px] hover:bg-emerald-400 transition-all shadow-2xl shadow-emerald-500/20 group">
                    Deploy Capital Now
                    <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform md:size-[18px]" />
                  </Link>
                  <button className="flex items-center justify-center gap-3 px-6 md:px-10 py-4 md:py-5 bg-zinc-800/50 border border-zinc-700/50 text-white rounded-xl md:rounded-2xl font-bold uppercase tracking-widest text-[10px] md:text-[11px] hover:bg-zinc-800 transition-all">
                    View Alpha Plans
                  </button>
                </div>
        ...
        <section id="partners" className="py-20 border-y border-zinc-800/10 overflow-hidden bg-[#0c0c0e]">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <p className="text-center text-[8px] md:text-[9px] font-black uppercase tracking-[0.3em] md:tracking-[0.5em] text-zinc-600 mb-8 md:mb-12 italic">Settlement provided by institutional custodians</p>
            <div className="flex flex-wrap justify-center items-center gap-x-10 md:gap-x-20 gap-y-8 md:gap-y-10 opacity-30 grayscale saturate-0 contrast-150">
               {partners.map((p, i) => (
                 <span key={i} className="text-xl md:text-3xl font-black font-serif italic text-white tracking-tighter hover:text-emerald-500 transition-all cursor-default">
                   {p}
                 </span>
               ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-12 lg:gap-24">
             {stats.map((stat, i) => (
                <div key={i} className={cn("text-center space-y-3 md:space-y-4 group", i === 2 && "sm:col-span-2 md:col-span-1")}>
                  <div className="text-5xl sm:text-6xl lg:text-8xl font-black text-white tracking-tighter italic font-serif leading-none group-hover:scale-110 transition-transform duration-700 tabular-nums">{stat.value}</div>
                  <div className="text-emerald-500 font-bold uppercase tracking-[0.3em] md:tracking-[0.4em] text-[9px] md:text-[10px] font-mono">{stat.label}</div>
                  <div className="w-10 md:w-12 h-[1px] bg-emerald-500/30 mx-auto" />
                </div>
             ))}
          </div>
        </section>
        ...
        <section id="protocol" className="py-20 md:py-32 px-4 md:px-6 bg-[#09090a]">
          <div className="max-w-7xl mx-auto">
             <div className="text-center mb-12 md:mb-32 space-y-4 md:space-y-6">
                <div className="w-12 md:w-16 h-1 bg-emerald-500 mx-auto rounded-full" />
                <h2 className="text-3xl sm:text-5xl md:text-7xl font-black text-white tracking-tighter font-serif italic uppercase leading-none">Protocol Core.</h2>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-5 md:gap-10">
                {/* Large Main Feature */}
                <div className="sm:col-span-2 md:col-span-12 lg:col-span-8 bg-[#0c0c0e] border border-zinc-800/40 rounded-[32px] md:rounded-[56px] p-8 md:p-12 flex flex-col justify-between overflow-hidden relative group hover:border-emerald-500/20 transition-all duration-700 shadow-2xl min-h-[400px]">
                   {/* Background Image */}
                ...
                {/* Right Top */}
                <div className="sm:col-span-1 md:col-span-6 lg:col-span-4 bg-emerald-500 rounded-[32px] md:rounded-[56px] p-8 md:p-12 flex flex-col justify-between group overflow-hidden relative shadow-[0_20px_50px_rgba(16,185,129,0.15)] active:scale-95 transition-all min-h-[300px]">
                   {/* Background Image */}
                   ...
                   <div className="relative z-10">
                      <h3 className="text-2xl md:text-3xl font-black text-black mb-2 md:mb-3 uppercase tracking-tighter italic">Alpha Bolt</h3>
                ...
                <div className="sm:col-span-1 md:col-span-6 lg:col-span-5 bg-zinc-900/50 border border-zinc-800/40 rounded-[32px] md:rounded-[56px] p-8 md:p-12 flex flex-col justify-between group hover:bg-zinc-900 transition-all shadow-2xl relative overflow-hidden min-h-[300px]">
                   ...
                   <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12 relative z-10">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-zinc-800/50 border border-zinc-700/50 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
                         <Globe size={18} className="md:size-[22px]" />
                      </div>
                      <div className="h-px flex-1 bg-zinc-800/50" />
                   </div>
                   <div className="relative z-10">
                      <h3 className="text-xl md:text-2xl font-black text-white mb-3 md:mb-4 uppercase tracking-tighter italic">Global Reserve</h3>
                      <p className="text-zinc-500 text-sm md:text-base leading-relaxed font-medium">Liquidate into fiat or digital stores in over 140+ countries within one banking day. Complete sovereign control.</p>
                   </div>
                </div>

                {/* Bottom Left Small */}
                <div className="sm:col-span-2 md:col-span-12 lg:col-span-7 bg-[#0c0c0e] border border-zinc-800/40 rounded-[32px] md:rounded-[56px] p-8 md:p-12 flex flex-col sm:flex-row items-center justify-between group overflow-hidden shadow-2xl relative gap-8 min-h-[250px]">
                   {/* Background Image */}
                   <div className="absolute inset-0 z-0 opacity-[0.03] group-hover:opacity-[0.06] transition-opacity duration-1000 grayscale">
                      <img 
                   ...
                   <div className="flex-1 space-y-4 md:space-y-6 relative z-10 w-full">
                      <div className="flex gap-2 md:gap-3">
                         {[1,2,3,4,5].map(i => <div key={i} className="w-6 md:w-8 h-1.5 md:h-2 bg-emerald-500 rounded-full" />)}
                      </div>
                      <h3 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tighter italic">Intelligence Matrix</h3>
                      <p className="text-zinc-600 text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em]">Real-time Portfolio Alpha metrics</p>
                   </div>
                   <div className="w-32 h-32 md:w-40 md:h-40 bg-emerald-500/5 rounded-full border border-emerald-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-700 relative z-10 shrink-0">
                      <BarChart3 size={40} className="text-emerald-500/40 animate-pulse md:size-[48px]" />
                   </div>
                </div>
             </div>
          </div>
        ...
        <section className="py-20 md:py-40 px-4 md:px-6 relative overflow-hidden bg-[#070708]">
           <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-16 md:gap-20 items-center">
              <div className="order-2 lg:order-1 relative w-full">
                 ...
                 <motion.div
                   ...
                   viewport={{ once: true }}
                   className="relative bg-[#0c0c0e] border border-zinc-800 rounded-[32px] md:rounded-[48px] p-6 md:p-8 shadow-[0_40px_100px_rgba(0,0,0,0.6)] group"
                 >
                    ...
                    <div className="space-y-6 md:space-y-10">
                       <div className="p-6 md:p-8 bg-zinc-900/50 rounded-2xl md:rounded-3xl border border-zinc-800">
                          <div className="flex flex-col sm:flex-row justify-between items-start mb-6 gap-4">
                             ...
                             <div className="px-3 py-1 bg-emerald-500/20 rounded-lg text-emerald-500 text-[10px] font-bold self-start sm:self-center">+14.2%</div>
                          </div>
                       ...
                       <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                          ...
                          <div className="p-5 md:p-6 bg-zinc-900 rounded-2xl md:rounded-3xl border border-zinc-800 space-y-3">
                             ...
                             <p className="text-lg md:text-xl font-bold text-emerald-500 font-serif italic">Premium Flow</p>
              ...
              <div className="order-1 lg:order-2 space-y-6 md:space-y-10">
                 <span className="text-emerald-500 text-[9px] md:text-[11px] font-black uppercase tracking-[0.3em] md:tracking-[0.5em] block">Unified Asset Management</span>
                 <h2 className="text-4xl md:text-7xl font-black text-white font-serif italic tracking-tighter leading-[0.95] md:leading-none uppercase">
                  ...
                  <p className="text-zinc-500 text-base md:text-xl font-medium leading-relaxed max-w-xl">
                  ...
                  <ul className="space-y-4 md:space-y-6">
                     {[
                       ...
                       'Dedicated Wealth Concierge'
                        ...
                        <li key={i} className="flex items-center gap-3 md:gap-4 text-zinc-300 font-bold uppercase tracking-widest text-[9px] md:text-xs">
                           <div className="w-5 h-5 md:w-6 md:h-6 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 shrink-0">
                  ...
                  <div className="pt-4 md:pt-6">
                    <Link to="/signup" className="inline-flex items-center gap-4 text-emerald-500 font-black uppercase tracking-widest text-[10px] md:text-xs group">
        ...
        <section id="infrastructure" className="py-24 md:py-40 px-4 md:px-6 bg-[#070708]">
          <div className="max-w-7xl mx-auto">
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 lg:gap-32 items-center">
                <div className="space-y-10 md:space-y-12">
                   <div className="inline-block px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-emerald-500 text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] md:tracking-[0.4em]">Hardware-Back Security</div>
                   <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-white italic tracking-tighter uppercase font-serif mb-6 leading-tight">THE FORTRESS.</h2>
                   <div className="space-y-8 md:space-y-10">
                      {[
                        ...
                        <div key={i} className="flex gap-5 md:gap-8 group pt-6 border-t border-zinc-800/50">
                           <div className="w-12 h-12 md:w-14 md:h-14 bg-zinc-900 border border-zinc-800 rounded-2xl flex items-center justify-center text-zinc-600 group-hover:text-emerald-500 group-hover:border-emerald-500/30 transition-all duration-300 shrink-0">
                              <item.icon size={20} className="md:size-6" />
                           </div>
                           <div>
                              <h4 className="text-base md:text-lg font-black text-white mb-1 md:mb-2 uppercase tracking-tighter italic">{item.title}</h4>
                              <p className="text-zinc-500 text-xs md:text-base leading-relaxed font-medium">{item.desc}</p>
                           </div>
                        </div>
                      ))}
                   </div>
                ...
                <div className="relative">
                   ...
                   <div className="bg-zinc-900/50 border border-emerald-500/10 rounded-[40px] md:rounded-[64px] p-8 md:p-14 relative overflow-hidden group shadow-2xl backdrop-blur-sm">
                      ...
                      <div className="space-y-10 md:space-y-12">
                         <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 border-b border-zinc-800/50 pb-8 md:pb-10">
                            <div>
                               <p className="text-[8px] text-zinc-500 font-black uppercase tracking-widest mb-1 md:mb-2">Protocol Hash</p>
                               <p className="text-[10px] font-mono text-zinc-400">0x7F8C4...B2D1</p>
                            </div>
                            <div className="sm:text-right">
                               <p className="text-[8px] text-zinc-500 font-black uppercase tracking-widest mb-1 md:mb-2">Node Efficiency</p>
                               <p className="text-xl md:text-2xl font-black text-emerald-500 font-mono tracking-tighter">99.8%</p>
                            </div>
                         </div>
                         
                         <div className="grid grid-cols-5 sm:grid-cols-6 gap-2 md:gap-3">
                            {Array.from({length: 25}).map((_, i) => (
                               <div key={i} className="h-8 md:h-10 bg-zinc-950/80 border border-zinc-800/50 rounded-lg md:rounded-xl flex items-center justify-center hover:border-emerald-500/20 transition-all cursor-default">
                         ...
                         <div className="p-6 md:p-8 bg-zinc-950/80 rounded-[24px] md:rounded-[40px] border border-zinc-800/50 flex flex-col md:flex-row items-center gap-6 md:gap-8 shadow-inner">
                            <Activity className="text-emerald-500/30 animate-pulse block" size={28} />
        ...
        <section className="py-20 md:py-40 px-4 md:px-6 bg-[#09090a] relative overflow-hidden">
           <div className="absolute top-0 left-0 w-full h-px bg-zinc-800/50" />
           <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12 md:mb-24">
                 <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-white italic tracking-tighter uppercase font-serif mb-4 md:mb-6 leading-tight">PROTOCOL TESTIMONIALS.</h2>
                 <p className="text-emerald-500 text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] md:tracking-[0.5em]">Verified Global Asset Allocators</p>
              </div>
                 ...
                 <AnimatePresence mode="wait">
                    ...
                    >
                       <div className="relative group w-full max-w-sm mx-auto lg:max-w-none">
                          ...
                          <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 w-24 h-24 md:w-32 md:h-32 bg-emerald-500 flex items-center justify-center rounded-2xl md:rounded-3xl shadow-xl shadow-emerald-500/20 z-10 shrink-0">
                       ...
                       <div className="space-y-8 md:space-y-10">
                          ...
                          <div className="pt-8 md:pt-10 border-t border-zinc-800/50">
                             <h4 className="text-lg md:text-xl font-black text-white italic tracking-widest uppercase">{testimonials[activeTestimonial].name}</h4>
                             <p className="text-zinc-500 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] md:tracking-[0.3em] mt-1 md:mt-2">{testimonials[activeTestimonial].role}</p>
                             <div className="flex items-center gap-2 mt-3 md:mt-4 text-[9px] md:text-[10px] text-emerald-500/60 font-black uppercase tracking-widest">
        ...
        <section className="py-20 md:py-48 px-4 md:px-6 relative overflow-hidden">
           ...
           <div className="max-w-6xl mx-auto rounded-[40px] md:rounded-[80px] border border-zinc-800/50 bg-[#0c0c0d] p-8 md:p-32 text-center relative shadow-[0_0_150px_rgba(0,0,0,0.8)] border-b-0 overflow-hidden">
              ...
              >
                 <div className="inline-block px-6 py-3 md:px-10 md:py-4 bg-emerald-500/5 border border-emerald-500/10 rounded-full">
                    <span className="text-emerald-500 text-[8px] md:text-[10px] font-black uppercase tracking-[0.4em] md:tracking-[0.6em]">Secure Your Legacy</span>
                 </div>
                 <h2 className="text-4xl sm:text-6xl md:text-9xl font-black text-white tracking-tighter italic font-serif leading-none">THE PRIVATE <br className="hidden sm:block" /> POOL AWAITS.</h2>
                 <p className="text-zinc-500 text-base md:text-2xl max-w-2xl mx-auto font-medium leading-relaxed italic">Account verification is instant. Deploy capital to institutional registries in under 120 seconds.</p>
                 <div className="flex flex-col xl:flex-row items-center justify-center gap-6 md:gap-8 pt-6 md:pt-10">
                    <Link to="/signup" className="group w-full xl:w-auto px-10 py-5 md:px-16 md:py-7 bg-white text-black rounded-2xl md:rounded-[32px] font-black uppercase tracking-widest text-[10px] md:text-[12px] flex items-center justify-center gap-4 md:gap-5 hover:bg-emerald-500 transition-all shadow-[0_20px_50px_rgba(255,255,255,0.05)] active:scale-95 shrink-0">
